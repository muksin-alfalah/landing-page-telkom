...
<head>
    <title>TELKOM WITEL JAMBI</title>
    ...
    <div id="home">
                            ...
                            <div class="navbar-nav secondfix ml-lg-auto">
                                <ul class="navbar-nav text-center">
                                    ...
                                    <li class="nav-item  mr-3">
                                        <a class="nav-link scroll" href="#about">profil</a>
                                    </li>
                                    <li class="nav-item  mr-3">
                                    ...
                                    <li class="nav-item">
                                     ...
                                     <li class="nav-item">
                                        <a class="nav-link scroll" href="#contact">tanggap covid-19</a>
                                    </li>
                                    <li class="nav-item">
                            ...
                            <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
                                ...
                                <div class="carousel-inner">
                                    <div class="carousel-item active">
                                        ...
                                        <p class="mt-2">sebaik-baiknya ilmu adalah ilmu yang bermanfaat</p>
                                    </div>
                                    <!-- slider text -->
                                    <div class="carousel-item">
                                        <h3 class="b-w3ltxt text-capitalize mt-md-4">
                                            <span>successful </span>careers</h3>
                                        <p class="mt-2">perjalanan panjang yang pernah dilalui kelak akan menjadi pengalaman yang sangat berharga</p>
                                    </div>
                                    <!-- slider text -->
                                    <div class="carousel-item text-white">
                                        <h3 class="b-w3ltxt  text-capitalize mt-md-4">
                                            <span>expert</span> consultants</h3>
                                        <p class="mt-2">yang penting makan</p>
                                    </div>
                                    <!-- slider text -->
                                </div>
                            </div>
        ...
        <div class="serv_bottom py-sm-5 py-3">
            <div class="container">
                <div class="row">
                    <div class="col-lg-8">
                        <h4 class="agile-ser_bot text-light text-capitalize">isi apa</h4>
                        <p class="text-secondary">apa aja</p>
                    </div>
        ...
        <section class="py-md-5" id="sub-services">
            <div class="container">
                <div class="agileabt-w3">
                    <div class="row py-5">
                        <div class="col-lg-8">
                            <h3 class="stat-title"> Portofolio</h3>
                            {!! $portofolio->keterangan !!}
                        </div>
                        <div class="col-lg-4 grad_video my-lg-auto mt-5">
                            <img src="{{asset('template/images/i1.png')}}" class="img-fluid" alt="" />
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div class="contact-top1">
                            <form action="{{ url('contact-us') }}" method="POST" class="contact-wthree">
                                ...
                                <div class="form-group d-flex">
                                    ...
                                    <input class="form-control" type="text" placeholder="Johnson" name="nama" required="">
                                </div>
                                <div class="form-group d-flex">
                                    <label>
                                        Email
            ...
            <div class="container">
                <div class="row  py-lg-5">
                    <div class="col-lg-3 col-sm-6 footer-logo">
                        ...
                        <p class="mt-3">DHSAAKSJDHFJDSASKJDFHDJSJDFJHH</p>
                    </div>
